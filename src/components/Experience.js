            ...
            <div ref={about} className=' bg-zinc-800 rounded-xl container mx-auto p-5 opacity-70'>
                ...
                <div className='text-gray-100 p-5'>
                    ...
                    <ul className='list-disc text-xl'>
                        ...
                        <li> Developed and deployed Lambda functions in Node.js and Python to automate backend operations for chatbots and file management, enhancing workflow reliability. </li>
